...
class Segment:
    def __init__(self, coordinates_1, coordinates_2):
        """
        Принимает две координаты и раскладываю их в переменные
        :param coordinates_1: Первая координата
        :param coordinates_2: Вторая координата
        """
    ...
    def length(self):
        """
        Метод вычисляет длинну отрезка
