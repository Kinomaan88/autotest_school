...
class PublicTransport:
    ...
    def info(self):
        """
        Выводить на печать информацию о:
        марке, цвете, годе выпуска и мощности двигателя
        :return:
        """
...
class Bus(PublicTransport):
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int, passengers, park, fare):
    ...
    def park(self, park):
        """
        Проверяет номер парка, что он в диапазоне от 1000 до 9999
        :param park:
        :return:
        """
...
class Tram(PublicTransport):
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int, route, path: int, fare):
        super().__init__(brand, engine_power, year, color, max_speed)
        self.__route = route
        self.path = path
        self._fare = fare
