...
def letter_stat(our_str):
    """
    Создает словарь с параметрами ключ = буква, значение = количество вхождения
    :param our_str:
    :return: выводим словарь
    """
    # Здесь нужно написать код
    letters_dict = dict.fromkeys(our_str, 0) # Создаю словарь
    # Циклом считаю количество вхождений ключа в строку
    for key in our_str:
        letters_dict[key] += 1
    return letters_dict
